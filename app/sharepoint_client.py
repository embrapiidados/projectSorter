...
class SharePointClient:
    ...
    def download_file(self, file_path):
        ...
        try:
            ...
            # Construir o caminho relativo completo do arquivo
            file_url = f'/sites/{self.site_name}/{self.doc_library}/{file_path}'
            print(f"URL completa do arquivo: {file_url}")
            ...
            try:
                ...
                # Tentar construir diferentes URLs possíveis
                possible_urls = [
                    f'/sites/{self.site_name}/{self.doc_library}/{file_path}',
                    f'/sites/{self.site_name}/{file_path}',
                    f'/sites/{self.site_name}/Shared Documents/{file_path}',
                    f'/sites/{self.site_name}/Documents/{file_path}',
                    f'/sites/{self.site_name}/Documentos Compartilhados/{file_path}',
                    f'/sites/{self.site_name}/Documentos/{file_path}'
                ]
    ...
    def upload_file(self, file_content, file_path):
        ...
        try:
            ...
            # Construir o caminho relativo completo da pasta
            target_folder_url = f'/sites/{self.site_name}/{self.doc_library}/{folder_path}'
